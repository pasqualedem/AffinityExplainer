...
from affex.models.dcama.dcama import DCAMA
...
def train(epoch, model, dataloader, optimizer, training):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        result = model(batch['query_img'], batch['support_imgs'].squeeze(1), batch['support_masks'].squeeze(1), query_mask=batch['query_mask'])
...
if __name__ == '__main__':
    ...
    model = DCAMA(args.backbone, args.feature_extractor_path, use_original_imgsize=False, concat_support=(not args.remove_support_skip))

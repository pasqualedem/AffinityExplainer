...
from ...eval.linear import get_args_parser as get_linear_args_parser
from ...logging import setup_logging
from ...run.submit import get_args_parser, submit_jobs
...
class Evaluator:
    ...
    def __call__(self):
        from ...eval.linear import main as linear_main
